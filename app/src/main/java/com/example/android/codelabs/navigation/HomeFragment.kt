...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*val buttonSecond = view.findViewById<Button>(R.id.navigate_action_button)
        buttonSecond.setOnClickListener (Navigation.createNavigateOnClickListener(R.id.next_action,null))
*/
